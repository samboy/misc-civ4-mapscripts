...
def getGridSize(x):
        ...
        if y <= 0:
                ...
                return (12,8) # 48x32, TINY
        elif y == 2:
                return (16,12) # 64x48, SMALL
        elif y == 3:
                return (24,16) # 96x64, STANDARD
        elif y == 4:
                return (30,20) # 120x80, LARGE
        elif y == 5:
                return (32,24) # 128x128, HUGE
        else:
                return (y*8, y*6) # Some mods have super-huge map options
