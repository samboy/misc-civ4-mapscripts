...
##
## 20120612:
## 1) Bugfix with rocky maps; hack to make extra-extra huge maps (up
##    to 288x192!  Yes, Civ4 is buggy and slow with maps that huge, but, by
##    golly it can be done)
##
## 20120603:
...
OPTION_Pangaea = 1
OPTION_Wrap = 2
OPTION_MapResources = 3
OPTION_Handicap = 4
OPTION_NoRotate = 5
OPTION_SmoothPeaks = 6
OPTION_IslandFactor = 8
OPTION_Patience = 9
OPTION_MapRatio = 10
...
## GLOBAL TUNING VARIABLES: Change these to customize the map results
	...
	ratioValue = 2 # Overwritten for HUGE maps
...
def getGridSize(argsList):
    grid_sizes = {
		WorldSizeTypes.WORLDSIZE_DUEL:		(22,14),
		WorldSizeTypes.WORLDSIZE_TINY:		(30,20),
		WorldSizeTypes.WORLDSIZE_SMALL:		(40,26),
		WorldSizeTypes.WORLDSIZE_STANDARD:	(48,32),
		WorldSizeTypes.WORLDSIZE_LARGE:		(60,40),
		WorldSizeTypes.WORLDSIZE_HUGE:		(72,48)
    }
