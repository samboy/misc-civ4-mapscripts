...
##
## 20120612: Dry offshoot of Totestra/PerfectWorld
##
## 20120603:
...
## GLOBAL TUNING VARIABLES: Change these to customize the map results
	...
	if(seaLevel != 0):
        ...
        self.iceSlope = 0.33 # How quickly we reduce icebergs
        clim = mmap.getClimate() 
        if clim == 1: # Tropical
            self.tropicsLatitude = 46
	    self.iceSlope = 0 # Less ice
        elif clim == 2: # Arid
            self.tropicsLatitude = 46
            self.DesertPercent = 0.75
            self.PlainsPercent = 0.92
	    self.iceSlope = 0 # Less ice
        elif clim == 3: # Rocky
	    ...
	    self.iceSlope = 0.50 # Some more ice
            self.iceRange = 4
        elif clim == 4: # Cold
            self.tropicsLatitude = 23
            self.SnowTemp = .25
            ...
            self.iceRange = 6
            self.iceChance = 1
	    self.iceSlope = 0.50 # Lots of ice
